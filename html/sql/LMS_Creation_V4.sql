...
CREATE TABLE IF NOT EXISTS `SECTIONS_MATERIALS_COMPLETION` (
  ...
  CONSTRAINT FK_SECTIONS_MATERIALS_COMPLETION FOREIGN KEY (SECTION_ID) REFERENCES SECTIONS(SECTION_ID),
  CONSTRAINT FK_SECTIONS_MATERIALS_COMPLETION2 FOREIGN KEY (USERID) REFERENCES LEARNERS(USERID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
