...
CREATE TABLE IF NOT EXISTS `MCQ_OPTIONS` (
  ...
  `CORRECT_OPTION` BOOLEAN NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `MCQ` (
  `QUESTION_ID` INT NOT NULL,
  PRIMARY KEY ( `QUESTION_ID`),
  CONSTRAINT FK_MCQ FOREIGN KEY (QUESTION_ID) REFERENCES QUIZ_QUESTION(QUESTION_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('1','6','1',FALSE)
;
INSERT INTO `MCQ` ( `QUESTION_ID`) VALUES
('1'),
('2'),
('3');
COMMIT;
